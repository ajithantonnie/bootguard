...
public class FileLoaderImpl implements FileLoader {
    ...
    public List<ConfigFile> loadConfigs(File directory, File ignoreFile) {
    ...
    private static void findConfigFiles(File dir, List<File> result, File ignoreFile) {
        ...
        List<String> ignoredDirs = new bootguard.utils.impl.AppConfigImpl().getStringList("ignore.directories");
