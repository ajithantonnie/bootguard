...
import bootguard.scanner.H2ConsoleCheck;
...
public class H2ConsoleCheckImpl implements H2ConsoleCheck {
    public List<Issue> scan(FileLoader.ConfigFile config) {
        ...
        if ("true".equalsIgnoreCase(h2Enabled)) {
            ...
            List<String> weakPasswords = new bootguard.utils.impl.AppConfigImpl().getStringList("h2.weak.passwords");
